...
fun EntradaScreen(
    ...
    LaunchedEffect(entradaId) {
        println("id $entradaId")
        entradaId?.let {
            if (it > 0){
                viewModel.selectedEntrada(it)
            }
        }
    }
        ...
        Column(
            ...
            ElevatedCard(
                ...
                Column(
                    ...
                    OutlinedTextField(
                        value = uiState.entradaId?.toString() ?: "Nuevo",
                        onValueChange = {},
                        modifier = Modifier.fillMaxWidth(),
                        readOnly = true,
                        enabled = false
